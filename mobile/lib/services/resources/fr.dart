Map<String, dynamic> fr = {
  'puzzle': {
    'error': 'Une erreur s\'est produite lors du chargement du puzzle hero.',
    'date': 'Le puzzle hero n\'est présentement pas disponible.',
    'title': 'Puzzle hero',
    'submit': 'Valider',
    'scan': 'Scan',
    'completed': 'Complété',
    'scan-error': 'Une erreur s\'est produite lors du scan du code qr.',
    'validation-error': 'Une erreur s\'est produite lors de la validation de la réponse.'
  },
  'login': {
    'title': 'Connexion',
    'pwd': 'Mot de passe',
  ...
  'profile': {
    ...
    'errors': {
      ...
      'twice-title': 'Participant déjà scanné',
      'twice-desc': 'Vous ne pouvez pas scanner un participant 2 fois.'
    }
  },
  'sponsors': {
